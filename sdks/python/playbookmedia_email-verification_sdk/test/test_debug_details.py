...
class TestDebugDetails(unittest.TestCase):
    """DebugDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DebugDetails:
        """Test DebugDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DebugDetails`
        """
        model = DebugDetails()
        if include_optional:
            return DebugDetails(

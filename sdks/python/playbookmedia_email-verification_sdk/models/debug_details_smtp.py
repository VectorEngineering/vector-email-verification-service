...
class DebugDetailsSmtp(BaseModel):
    """
    SMTP details used for debugging, including the verification method.
    """ # noqa: E501
    verif_method: Optional[VerifMethod] = None
    __properties: ClassVar[List[str]] = ["verif_method"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of verif_method
        if self.verif_method:
            _dict['verif_method'] = self.verif_method.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "verif_method": VerifMethod.from_dict(obj["verif_method"]) if obj.get("verif_method") is not None else None
        })
        return _obj

...
class PostV1BulkRequest(BaseModel):
    """
    PostV1BulkRequest
    """ # noqa: E501
    input: List[StrictStr] = Field(description="A list of emails to verify.")
    webhook: Optional[TaskWebhook] = None
    __properties: ClassVar[List[str]] = ["input", "webhook"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "input": obj.get("input"),
            "webhook": TaskWebhook.from_dict(obj["webhook"]) if obj.get("webhook") is not None else None
        })
        return _obj

...
class Duration(BaseModel):
    ...
    """ # noqa: E501
    secs: Union[StrictFloat, StrictInt] = Field(description="Duration in seconds.")
    nanos: Union[StrictFloat, StrictInt] = Field(description="Duration in nanoseconds.")
    __properties: ClassVar[List[str]] = ["secs", "nanos"]
